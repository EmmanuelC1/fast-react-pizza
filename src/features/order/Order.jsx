...
function Order() {
  ...
  // load menu data from menu component, avoiding us to fetch same data from API
  useEffect(
    function () {
      // make sure we dont already have the data, and check if fetcher is not loading already
