...
function Button({ children, disabled, to, type, onClick }) {
  ...
  // if Button component has 'to' prop, render a Link component to navigate to path
  if (to) {
    return (
  ...
  // if Button component has 'onClick' prop, render a button element with onClick method to handle onClick
  if (onClick) {
    return (
